...
const defaultAppEnv = {
  ...
  EXPO_PUBLIC_GOOGLE_CALENDAR_ENABLED: false,
...
const googleCalendarEnabledFromEnv = z.preprocess((value) => {
  if (typeof value === 'boolean') {
    return value;
  }
...
export const appEnvSchema = z.object({
  ...
  EXPO_PUBLIC_GOOGLE_CALENDAR_ENABLED: googleCalendarEnabledFromEnv,
